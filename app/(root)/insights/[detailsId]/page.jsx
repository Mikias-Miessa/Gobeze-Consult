...
const page = () => {
  return (
    <div>
      ...
      <div className='mr-40 ml-48 my-14'>
      <div className='flex mb-16'>
        <div className='mr-40'>Blogs  - Posted in  September 22, 2023</div>
        <div className='ml-80'>post by : Abebe Kebede</div>
      </div>
      <div className='text-7xl font-bold'>How The Athletics Great Became A Business Mogul</div>
      <Image src={Detail} className='h-96 w-full my-8 mr-5'/>
      <div className='grid grid-cols-2 gap-10 mb-8'>
        <div className='mr-5'>
          <h1 className='text-4xl font-semibold mb-10 ml-5'>“ When you run the marathon, you run against the distance, not against the other runners and not against the time. “</h1>
          ...
          <h3 className="mt-8">Gebrselassie's running career spanned over two decades, and he became an iconic figure in Ethiopian and global athletics. After retiring from competitive running, he has been involved in various business ventures and philanthropic activities.</h3>
        </div>
        <div className='mt-14 text-grey-700 mr-5'>
          ...
          <div>
            <h1 className='font-bold mt-8'>Born to run</h1>
          ...
          <div>
          <h1 className='font-bold mt-8'>Great rivalry</h1>
          ...
          <div>
          <h1 className='font-bold mt-8'>A change of pace</h1>
          ...
          <div>
          <h1 className='font-bold mt-8'>Passing on the legacy</h1>
          <h3>At the 2008 Beijing Games, Haile Gebrselassie finished sixth in the marathon. It was won by Kenenisa Bekele, who is considered to be his distance-running heir.</h3>
          </div>
        </div>
      </div>
