  ...
  return (
    ...
    <div className='grid md:grid-cols-7 grid-cols-1 md:mt-20 mt-4 mb-5 pt-20 bg-black md:pr-20 pr-5 pb-3'>
      ...
      <h1 className='md:text-7xl text-4xl md:font-bold font-medium text-gray-500'>
        ...
        <div className='md:ml-36 ml-5 mb-4 mt-7 mr-5 bg-white h-56 '>
            <h3 className='px-10 py-12 text-2xl text-center'> Help good people win, by providing them with easy access to the right 
