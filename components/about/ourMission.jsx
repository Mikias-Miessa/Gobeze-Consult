    ...
    <div id='vision' className=''>
      <div className='grid md:grid-cols-7 grid-cols-1 md:mt-20 mt-4 bg-black md:pr-20 pr-5 py-24 '>
        <div className='col-span-5'>
          ...
          <div className='md:ml-36 ml-10 mb-4 mt-7 mr-5 bg-white md:h-56 '>
            <h3 className='px-10 py-5 text-3xl text-center'>
              {' '}
              Help good people win, by providing them with easy access to the
              right skills, tools, inspiration and support required to realize
              their potential and become wildly successful in life.
            </h3>
          </div>
          ...
          <div className='md:block hidden'>
            <Image
              src={ImageCenter2}
              alt='VisionPerson'
              className='md:h-72 h-52 md:w-full w-80 md:m-20 m-8 md:my-0 md:pl-16 pl-1'
            />
          </div>
        </div>
        ...
        <div className='col-span-2 md:block hidden'>
          <Image
            ...
            height={100}
            className='md:absolute md:w-96 w-80 md:h-fit h-96 md md:ml-0 ml-10 md:my-4 my-1'
          />
        </div>
      </div>
    </div>
