  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className='-mt-10 bg-gradient-to-br from-slate-300 to-slate-500  bg-clip-text text-center text-2xl font-medium tracking-tight text-transparent md:text-5xl'
      >
        Our Team
      </motion.h1>
    </LampContainer>
  ...
  return (
    ...
    >
      <div className='relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 '>
        ...
        <div className='absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-orange-700 opacity-50 blur-3xl'></div>
        <motion.div
          initial={{ width: '8rem' }}
          ...
          className='absolute inset-auto z-30 h-20 w-64 -translate-y-[6rem] rounded-full bg-orange-200 blur-2xl'
        ></motion.div>
        <motion.div
          initial={{ width: '15rem' }}
