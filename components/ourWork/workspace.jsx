...
function WorkSpace() {
  return (
    <div id='workspace'> 
      <div className='grid md:grid-cols-3 grid-cols-1 md:my-10 md:mx-40 md:gap-8 my-3 mx-5'>
        <div className='md:mt-36 mt-5 md:mb-10 mb-2'>
        ...
        <div className='md:h-fit h-full'>
        <Image src={Rectangle2} alt='imgWorkSpace2' className='md:mb-8 mb-2'/>
        <Image src={Rectangle3} alt='imgWorkSpace3'/>
        </div>
