              ...
              {subLink === 2 && (
                <div
                  className='absolute  -top-1 flex justify-start 2xl:-left-[700px] xl:-left-[530px] lg:-left-[500px] md:-left-[400px] transition group-hover:translate-y-5 translate-y-0
                    opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-500 ease-in-out
                    group-hover:transform z-50 min-w-fit transform w-screen h-[300px]'
                >
                  <div className='relative top-6 p-6 bg-white rounded shadow-xl flex flex-row w-screen h-fit 2xl:gap-16 xl:gap-14 lg:gap-10 md:gap-6 justify-evenly'>
                    <div className='relative -left-[30px] w-[70%] h-[300px] flex justify-evenly -mt-16'>
                      <div className=' my-20 flex flex-col gap-4 pl-10 mt-28  '>
                      ...
                      <div className='border-r h-[100px] w-1 self-center mt-10'></div>
                      <div className=' text-center my-20 '>
